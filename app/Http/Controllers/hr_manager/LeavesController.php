...
class LeavesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('hr_manager.leaves.list', compact('leaveTypes', 'leaves'));
    }
    ...
    public function create()
    {
        ...
        return view('hr_manager.leaves.partials.create', compact('leave_types', 'leave', 'leaveTypes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('hr_manager.leaves');
    ...
    public function edit(string $id)
    {
        ...
        return view('hr_manager.leaves.partials.edit', compact('leave', 'leaveTypes', 'leave_types'));
    }
    ...
    public function leaveRequests()
    {
        ...
        $leaves = Leave::whereIn('user_id', $users->pluck('id'))->get();
        return view('hr_manager.leaves.leave_requests', compact('leaves'));
    }
    ...
    public function approveLeave(string $id)
    {
        ...
        try {
            ...
            flash()->options([
                'timeout' => 3000,
                'position' => 'bottom-right',
            ])->success('Leave ID ' . $id . ' Approved Successfully!');
            return redirect()->back();
        } catch (\Throwable $e) {
            DB::rollBack();
            flash()->options(['timeout' => 3000, 'position' => 'bottom-right'])
    ...
    public function rejectLeave(string $id)
    {
        ...
        try {
            ...
            flash()->options([
                'timeout' => 3000,
                'position' => 'bottom-right',
            ])->success('Leave ID ' . $id . ' Rejected Successfully!');
            return redirect()->back();
        } catch (\Throwable $e) {
            DB::rollBack();
            flash()->options(['timeout' => 3000, 'position' => 'bottom-right'])
