    ...
    <section>
        ...
        <div class="row">
            <div class="col text-end pb-2" title="Apply for Leave">
                <a href="{{ route('hr_manager.leaves.create') }}" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        @foreach ($leaves as $leave)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($leave->status == 'Pending')
                                                        <a href="{{ route('hr_manager.leaves.edit', $leave->id) }}"
                                                            class="btn btn-light btn-sm text-primary" title="Edit">
                                                            <i class="ri-edit-line"></i>
                                                        </a>
                                                        @if (Route::has('hr_manager.leaves.destroy'))
                                                            <form
                                                                action="{{ route('hr_manager.leaves.destroy', $leave->id) }}"
